              ...
              <div class="flex items-center gap-1 sm:gap-2">
                ...
                >
                  ...
                  @if (cartService.itemCount() > 0) {
                    <span class="absolute top-0.5 right-0.5 sm:top-1 sm:right-1 min-w-[20px] h-5 px-1.5 bg-theme-fg text-white text-xs font-bold rounded-full flex items-center justify-center animate-scale-in">
