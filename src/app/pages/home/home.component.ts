...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-theme-surface font-sans antialiased">
        ...
        <div class="bg-theme-secondary border-b-2 border-theme-border">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16 md:pt-20 md:pb-24">
            <div class="text-center max-w-4xl mx-auto">
              ...
              <!-- Main Heading -->
              <h1 class="font-display tracking-tighter mt-0 text-5xl md:text-7xl lg:text-8xl font-bold text-theme-fg mb-6 leading-tight">
                Quick Sell<br class="hidden sm:block">
                <span class="text-[rgb(124_58_237_/_var(--tw-bg-opacity,_1))]">like no one else.</span>
              </h1>

              <!-- Subtext -->
              <p class="text-lg md:text-xl text-theme-fg/70 max-w-2xl mx-auto mb-10 font-medium">
              ...
              <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a routerLink="/become-creator" (click)="handleCreatorCtaClick($event)" class="inline-flex items-center justify-center px-8 py-4 bg-theme-accent text-[#1A1A1A] border-2 border-theme-border font-bold text-lg shadow-[4px_4px_0px_0px_#000] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_#000] transition-all cursor-pointer">
                  Start selling &#8212; it's free
                  <lucide-icon [img]="ArrowRight" [size]="24" [strokeWidth]="2.5" class="ml-2"></lucide-icon>
                </a>
                <a routerLink="/explore" class="inline-flex items-center justify-center px-8 py-4 bg-theme-surface text-theme-fg border-2 border-theme-border font-bold text-lg shadow-[4px_4px_0px_0px_rgb(43_87_214)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgb(43_87_214)] transition-all">
                  Explore stores
                </a>
              </div>
            </div>
      ...
      @if (uiMessages.inlineTips().length > 0) {
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
          @for (msg of uiMessages.inlineTips(); track msg.id) {
            <div class="bg-theme-secondary/60 border-2 border-theme-border px-5 py-4 flex items-start gap-3 mb-4 last:mb-0 shadow-[2px_2px_0px_0px_#000]">
              <span class="mt-0.5 flex-shrink-0 text-theme-fg">
      ...
      <section class="py-16 md:py-24 px-4 sm:px-6 lg:px-8 border-b-2 border-theme-border">
        <div class="max-w-7xl mx-auto">
          <h2 class="font-display tracking-tighter text-4xl md:text-5xl font-bold text-theme-fg text-center mb-12">
            Three steps. That's it.
          </h2>

          <div class="grid md:grid-cols-3 gap-6 md:gap-8">
            <!-- Step 1 -->
            <div class="bg-theme-surface border-2 border-theme-border p-6 md:p-8 shadow-[6px_6px_0px_0px_rgb(255_198_11)] hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_rgb(255_198_11)] transition-all duration-200">
              <div class="w-12 h-12 md:w-16 md:h-16 bg-theme-accent border-2 border-theme-border flex items-center justify-center mb-6">
                <span class="font-display text-2xl md:text-3xl font-bold text-[#1A1A1A]">1</span>
              </div>
              <h3 class="font-display text-xl md:text-2xl font-bold text-theme-fg mb-3">Create your Store</h3>
              <p class="text-theme-fg/70 font-medium">Sign up and set up your storefront in under a minute. No code needed.</p>
            </div>

            <!-- Step 2 -->
            <div class="bg-theme-surface border-2 border-theme-border p-6 md:p-8 shadow-[6px_6px_0px_0px_rgb(124_58_237)] hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_rgb(124_58_237)] transition-all duration-200 mt-0 md:mt-8">
              <div class="w-12 h-12 md:w-16 md:h-16 bg-[#7C3AED] border-2 border-theme-border flex items-center justify-center mb-6">
                <span class="font-display text-2xl md:text-3xl font-bold text-white">2</span>
              </div>
              <h3 class="font-display text-xl md:text-2xl font-bold text-theme-fg mb-3">Add your products</h3>
              <p class="text-theme-fg/70 font-medium">Upload digital files, physical goods, or memberships. Up to 20GB per file.</p>
            </div>

            <!-- Step 3 -->
            <div class="bg-theme-surface border-2 border-theme-border p-6 md:p-8 shadow-[6px_6px_0px_0px_rgb(104_224_121)] hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_rgb(104_224_121)] transition-all duration-200 mt-0 md:mt-16">
              <div class="w-12 h-12 md:w-16 md:h-16 bg-theme-success border-2 border-theme-border flex items-center justify-center mb-6">
                <span class="font-display text-2xl md:text-3xl font-bold text-theme-fg">3</span>
              </div>
              <h3 class="font-display text-xl md:text-2xl font-bold text-theme-fg mb-3">Share & sell</h3>
              <p class="text-theme-fg/70 font-medium">Share your shop link anywhere. Accept payments via Stripe, PayPal, and more.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-[#111111] border-b-2 border-theme-border">
        <div class="max-w-7xl mx-auto">
          ...
          <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            <div *ngFor="let benefit of benefits; let i = index" class="bg-[#111111] border-2 border-white p-6 md:p-8 hover:-translate-y-2 hover:shadow-[6px_6px_0px_0px_#fff] transition-all duration-300">
              <div class="w-12 h-12 bg-theme-surface border-2 border-white flex items-center justify-center mb-6">
                <lucide-icon [img]="benefit.icon" [size]="24" [strokeWidth]="2.5" class="text-theme-fg"></lucide-icon>
              </div>
      ...
      <!-- What You Can Sell -->
      <section class="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-theme-secondary border-b-2 border-theme-border">
        <div class="max-w-7xl mx-auto text-center">
          <h2 class="font-display tracking-tighter text-4xl md:text-5xl font-bold text-theme-fg mb-6">
            Sell anything. Seriously.
          </h2>
          <p class="text-lg md:text-xl text-theme-fg/70 max-w-2xl mx-auto mb-12 font-medium">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 md:gap-6">
            <div *ngFor="let item of sellableItems" class="bg-theme-surface border-2 border-theme-border p-6 md:p-8 shadow-[4px_4px_0px_0px_#000] hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_#000] transition-all duration-200 flex flex-col items-center">
              <lucide-icon [img]="item.icon" [size]="32" [strokeWidth]="2" class="mb-4 text-theme-fg"></lucide-icon>
              <span class="text-sm md:text-base font-bold text-theme-fg">{{ item.name }}</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="max-w-7xl mx-auto">
          ...
          <div class="grid md:grid-cols-3 gap-6 md:gap-8">
            <div *ngFor="let testimonial of testimonials"
                 class="p-6 md:p-8 border-2 border-theme-border transition-all duration-200"
                 [ngClass]="{
                   'bg-theme-border text-white shadow-[6px_6px_0px_0px_rgb(250_75_40)]': testimonial.featured, 
                   'bg-theme-surface text-theme-fg shadow-[6px_6px_0px_0px_#000]': !testimonial.featured
                  }">
              <p class="mb-6 font-medium text-lg leading-relaxed">
                "{{ testimonial.quote }}"
              </p>
              <div class="flex items-center gap-4">
                <div class="w-10 h-10 border-2 border-theme-border flex-shrink-0" [style.background-color]="testimonial.color"></div>
      ...
      <!-- FAQ Section -->
      <section class="py-16 md:py-24 px-4 sm:px-6 lg:px-8 border-b-2 border-theme-border bg-theme-secondary">
        <div class="max-w-4xl mx-auto">
          <h2 class="font-display tracking-tighter text-4xl md:text-5xl font-bold text-theme-fg text-center mb-12">
            Questions? Answered.
          </h2>

          <div class="border-2 border-theme-border bg-theme-surface shadow-[8px_8px_0px_0px_#000]">
            <div *ngFor="let faq of faqs; let last = last" [class.border-b-2]="!last" class="border-theme-border">
              <button
                (click)="toggleFaq(faq.id)"
                class="w-full text-left px-6 py-5 md:py-6 flex items-center justify-between font-bold text-theme-fg hover:bg-theme-secondary transition-colors duration-200 text-lg md:text-xl">
                {{ faq.question }}
                <div class="w-8 h-8 border-2 border-theme-border flex items-center justify-center bg-theme-surface flex-shrink-0 ml-4 group-hover:bg-theme-accent">
              ...
              <div class="overflow-hidden transition-all duration-300 bg-theme-surface" [class.max-h-0]="!faq.isOpen" [class.max-h-96]="faq.isOpen">
                <p class="text-theme-fg/80 px-6 pb-6 font-medium text-base md:text-lg border-t-2 border-theme-border mt-0 pt-4">{{ faq.answer }}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="py-20 md:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden relative">
        <div class="max-w-4xl mx-auto text-center relative z-10">
          <h2 class="font-display tracking-tighter text-5xl md:text-7xl font-bold text-theme-fg mb-6">
            Ready to sell?
          </h2>
          <p class="text-xl md:text-2xl text-theme-fg/70 mb-10 font-bold">No signup fees. No monthly charges. Just start.</p>
          <a routerLink="/become-creator" (click)="handleCreatorCtaClick($event)" class="inline-flex items-center justify-center px-10 py-5 bg-[#7C3AED] text-white border-2 border-theme-border font-display font-bold text-xl md:text-2xl shadow-[6px_6px_0px_0px_#000] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[4px_4px_0px_0px_#000] transition-all cursor-pointer">
