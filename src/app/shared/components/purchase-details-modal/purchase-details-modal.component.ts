  ...
  template: `
    @if (isOpen()) {
      ...
      >
        <!-- Modal -->
        <div 
          class="bg-theme-surface w-full sm:max-w-lg sm:rounded-2xl rounded-t-3xl border-2 border-theme-border shadow-[8px_8px_0px_0px_#000] overflow-hidden max-h-[90vh] overflow-y-auto safe-area-bottom"
        ...
        >
          ...
          <!-- Header -->
          <div class="px-6 py-5 border-b-2 border-theme-border bg-theme-secondary">
            <div class="flex items-center justify-between">
              ...
              <button 
                (click)="closeModal()"
                class="w-8 h-8 flex items-center justify-center border-2 border-theme-border bg-theme-surface shadow-[2px_2px_0px_0px_#000] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[1px_1px_0px_0px_#000] transition-all rounded-lg"
              >
            ...
            @if (purchase()) {
              <div class="space-y-6">
                ...
                <div class="flex gap-4 items-start">
                  <div class="w-24 h-24 shrink-0 bg-theme-secondary border-2 border-theme-border rounded-xl overflow-hidden">
                  ...
                  <div class="flex-1 min-w-0">
                    <a [routerLink]="['/product', purchase()?.product?.id]" class="font-bold text-lg text-theme-fg hover:underline line-clamp-2 mb-1">
                ...
                <!-- Key Information -->
                <div class="bg-theme-secondary border-2 border-theme-border rounded-xl p-4">
                ...
                <div>
                  <div class="flex items-center justify-between mb-3">
                    <h3 class="font-bold text-theme-fg text-sm uppercase tracking-wider">Files</h3>
                      ...
                      @for (file of purchase()?.product?.files; track file.id || file.fileId) {
                        ...
                        >
                          ...
                          @if (downloading() === (file.id || file.fileId)) {
                            <svg class="w-5 h-5 animate-spin text-theme-fg" fill="none" viewBox="0 0 24 24">
                              <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                              <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                            </svg>
                          } @else {
                            <svg class="w-5 h-5 text-theme-fg shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
